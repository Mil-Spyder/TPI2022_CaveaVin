    ...
    <div class="p-10">
            ...
            <div
                ...
                <div class="mb-8">
                    ...
                    <div class="flex flex-items-row">
                        <div class="text-gray-900 font-bold text-xl mb-2">{{$bottle->appelation}}Nom de la Cuvée
                            <p class="text-gray-700 font-light text-base"><div class="flex items-center">
                ...
                <div class="flex items-center">
                    ...
                    <div class="pl-4">
                        <ul>
                            <li><a href={{route('show')}}> plus</a></li>
                            <li><a href={{route('edit')}}>modifier </a></li>
        ...
        <div class="flex flex-row-reverse">
            <div class="py-4 px-4 mb-2 ">
                <button type="button"
                    class="text-white bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2"><a href="{{route('create')}}">Ajouter</a> 
                </button>
            </div>
        </div>
