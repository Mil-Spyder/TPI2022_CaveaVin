...
@section('content')
    <div class="p-10">
        ...
        <form method="put" action="{{ route('update', ['id' => $bottle->id])}}">
            @csrf

            <div class="mb-6">
                <label for="cuvee_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Nom de la
                    Cuvée</label>
                <input type="text" id="cuvee_name" name="cuvee_name" value="{{$bottle->cuvee_name}}"
            ...
            <div class="mb-6">
                ...
                <input type="text" id="appelation" name="appelation" value="{{$bottle->appelation}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            </div>
            <div class="mb-6">
                <label for="region" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">région</label>
                <input type="text" id="region" name="region" value="{{$bottle->region}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            </div>
            <div class="mb-6">
                <label for="vintage"
                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">millésime</label>
                <input type="text" id="vintage" name="vintage" value="{{$bottle->vintage}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            </div>
            ...
            <div class="mb-6">
                ...
                <input type="text" id="capacity" name="capacity" value="{{$bottle->capacity}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            </div>

            <div class="mb-6">
                <label for="color" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">couleur</label>
                <input type="text" id="color" name="color" value="{{$bottle->color}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            </div>
            ...
            <div class="mb-6">
                <label for="consumable" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">date
                    consomable</label>
                <input type="text" id="consumable" name="consumable" value="{{$bottle->consumable_date}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            </div>
            ...
            <div class="mb-6">
                <label for="peak" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">date
                    apogée</label>
                <input type="text" id="peak" name="peak" value="{{$bottle->peak_date}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            </div>
            ...
            <div class="mb-6">
                <label for="danger" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">date
                    danger</label>
                <input type="text" id="danger" name="danger" value="{{$bottle->danger_date}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            </div>
            ...
            <div class="mb-6">
                <textarea name="description" id="descritpion" cols="30" rows="5"
                    class=" bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="description">{{$bottle->description}}</textarea>
            </div>
            <div class="mb-6">
            ...
            <div class="mb-6">
                ...
                <input type="text" id="unit" min="0" max="99" name="unit" value="{{$bottle->unit}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            </div>

            <button type="submit"
                class="text-white bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">modifier</button>
        </form>
    </div>
@endsection
